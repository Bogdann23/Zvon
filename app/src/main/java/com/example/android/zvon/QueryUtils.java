...
public class QueryUtils {
    ...
    private static List<News> extractNewsFromJson(String newsJSON) {
        ...
        try {
            ...
            JSONObject jsonRoot = baseJsonResponse.getJSONObject("response");
            JSONArray newsArray = jsonRoot.getJSONArray("results");
            ...
            for (int i = 0; i < newsArray.length(); i++) {
                ...
                // Create a new {@link News} object with section, date, title, url,
                // and url from the JSON response.
                News newNews = new News(section, date, title, url);
